package cmo.trading.bitso.api_bitso.models.services.ExchangeServices;
...
import cmo.trading.bitso.api_bitso.models.services.HTTPServices.HTTPServiceBitso;
import cmo.trading.bitso.api_bitso.models.services.IServices.Exchange;

@Service("Bitso")
public class ExchangeBitso implements Exchange {
    ...
    public List<CryptoBalance> getMyBalance() throws Exception {
        HashMap<String, String> parameters = new HashMap<>();
        String result = httpServiceBitso.GETMethod(parameters, "/v3/balance/");
    ...
    public List<CryptoTrades> getMyTrades() throws Exception {
        HashMap<String, String> parameters = new HashMap<>();
        String result = httpServiceBitso.GETMethod(parameters, "/v3/user_trades/");
        JSONObject payload = new JSONObject(result);
